...
class Match(object):
    ...
    def play_match(self):
        ...
        filename = ('/Users/andrea/Desktop/fanta3_0/all_players_per_fantateam/'+
                    'fantaplayers/fantaplayers_%d.pckl' % self.day)
        ...
        for player1 in daily_players[self.team1]:
            ...
            and player1[0] not in [element[1] for element in self.final_bench1]):
        ...
        for player2 in daily_players[self.team2]:
            ...
            and player2[0] not in [element[1] for element in self.final_bench2]):
...
class League(object):
    ...
    def print_league(self):
        ...
        header = ['Points','V','N','P','Gs','Gt','Dr','Malus','Abs Points']
    ...
    def print_rates_bonus_malus(self):
        ...
        print('% of bonus/malus points used and points obtained thanks to 0.5.')
        print(table)
        print('\n')
